...
//		// str 변수에 값을 담는 함수
//		System.out.println(this.str);       // 이름이 곂칠경우에만 this. 씀
//		System.out.println(str);            // 이름이 안곂치면 그냥씀
//	
	String getStr() {       // 클래스명 this 이미 들어가 있음
		// str  변수를 사용하는 함수
		String str = "hello";
		System.out.println(str);         // 함수안에 있는 변수를 쓰고 싶다
		return str;                  // 멤버변수를 사용하고 싶다 this.
	}
	
//	String getStr(MyClass8 this) {       ==> 이런식으로
//		// str  변수를 사용하는 함수
//		return str;
//	}
}
