...
class MyClass5{
	...
	void 메서드2(String str1, String str2) {
		...
		// 코드 재활용의 목적 (입력되는 값만 변경하면서 재활용)
		System.out.println("소괄호로 넘어오는 값만 변경 "+str1+str2);
		System.out.println("코드 재활용 "+str2);
	}
	
	// 메서드3 : 반환값O, 입력값X (코드 재사용, 메서드 사용후에 마지막으로 전달해줄 값이 있음)
	String 메서드3() {
	...
	int 메서드4(double dnum) {
		...
		return (int)dnum;           // 소수점 부분을 int로 날림
	}
}
