...
public class Review {
	public static void main(String[] args) {
		...
		if(age >19) {
			...
			// 나이가 19보다는 크지 않고 13보다는 크면 실핼할 코드
			System.out.println("청소년입니다");
			money = 650;
		}else {
			// 나이가 19보다 크지않고 13보다 작은 나이면 실행할 코드
		...
		// 윤년 구하기
		int year = 0;
		Scanner sc = new Scanner(System.in);         // 사용자 입력을 받기 위해 해야할 것
		...
		// 지금은 main 함수가 종료되면 자동으로 해제되기 떄문에 지금은 안해도됨
