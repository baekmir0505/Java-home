...
public class Ex1 {
	public static void main(String[] args) {
		Human 백씨 = new Human("백미르", 23, false);
		백씨.말하기();
		백씨.밥먹기();
		
		HumanEx 송씨 = new HumanEx("첫사랑", 23, true);
		송씨.말하기();
		송씨.밥먹기();
		
		HumanDeco 최씨 = new HumanDeco("최민석",23, true);
		최씨.나이정보();
		최씨.말하기();
		...
		// ==> 문제발생원인? *복사 붙여넣기를 했기 때문에*
		// ==> '사람이' 복사 붙여넣기를 했기 때문에
		// ==> 컴퓨터가 알아서 복사 붙여넣기를 하게 하자(상속)
	}
}
