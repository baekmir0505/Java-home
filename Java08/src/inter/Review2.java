...
public class Review2 extends Review1 {
	...
	// 상속을 했더니 클래스명에 빨간색 밑줄이 그어진다? 명시해줘야하는 메서드가 있는것 (생성자)
	...
	// 상속(복붙)을 하는 이유는 '기존 클래스를 유지한채로 수정/추가 하기 위해서'
	// 수정(오버라이딩)을 통해서함 == (다시 만드는것, 재정의)
	@Override
	public void printNum() {
		// super.printNum();        // super.printNum() : 부모의 printNum을 사용(코드실행)
