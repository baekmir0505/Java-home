...
class MyClass1{
	...
	double dNum;
	// 맴버변수는 private, 메서드는 public (캡슐화, 정보은닉)
	private boolean bool;       // 클래스 맴버변수
...
class MyClass3 extends Adapter1{
	// 선어만 된 추상메서드를 오버라이딩 해줘야 오류가 없어짐
	// 클래스 이름 밑에 빨간줄에 마우스를 갖다대면 unimplemented methods 클릭
