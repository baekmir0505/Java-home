...
public class String1 {
	public static void main(String[] args) {
		...
		int result3 = str.indexOf("world");          // world의 w위치를 알려줌 (배열 형태로 ==> 0번부터)
		...
		String result5 = src.substring(gil, dong+1);      // gil ~ dong
		// String result5 = src.substring(1,3);           // 1부터 3전까지 (1~2) 자름
		System.out.println(result5);
		
		// quiz2. src 변수에서 홍길동을 장보고로 바꿔서 출력
		String src2 = "안녕하요 저는 홍길동입니다. 올해 23살입니다.";
