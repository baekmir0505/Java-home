...
public class Fuction1 {
	...
	// mian함수에 코딩을 하면 ==> 프로그램 실행시 main함수 실행
	public static void main(String[] args) {
		...
		// static : 정적, 고정시켜놓아서 어디서든지 접근할 수 있게끔 세팅 (대신 많이 쓰면 프로그램이 느려짐)
	...
	static void 함수명(int num1, int num2, int num3) {
		// 함수라는것은 사용자가 직접 만드는 연산자 (코드저장)
		// 숫자 3개를 한번에 더할 수 있는 연산자로 만들게요 (+ 기호는 2개만 더하기가 가능하지만)
		// A + B
		// 함수명(A,B,C);
